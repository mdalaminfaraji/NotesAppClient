...
const Footer:React.FC = () => {
  ...
  <div className=' w-[49%] mx-auto'>
    ...
    <p style={{fontFamily:'Rencho', fontSize:'45px',}}>Notes</p>
  ...
  <div>
    ...
    <div className=" w-[49%] mx-auto">
     ...
     <form>
        <input type="text" placeholder='Enter your Name' name="name" id="" className='text-black p-3 border-2 mt-2 border-slate-500 rounded-lg' /><br/>
        <input type="email" placeholder='Enter your Email' name="email" id="" className='text-black p-3 border-2 mt-2 border-slate-500 rounded-lg'/><br/>
        <textarea name="textarea" id="" cols={30} rows={5} placeholder='textarea.....' className='p-3 mt-2 border-2 border-slate-500 rounded-lg text-black'></textarea>
